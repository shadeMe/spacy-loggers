...
from spacy.util import SimpleFrozenList, registry
...
def clearml_logger_v2(
    ...
    def setup_logger(
        ...
        match_stat = setup_custom_stats_matcher(log_custom_stats)
...
def clearml_logger_v1(
    ...
    def setup_logger(
        ...
        console_log_step, console_finalize = _setup_console_logger(nlp, stdout, stderr)
        task, best_model, last_model = _setup_clearml(
            clearml,
            nlp,
            project_name,
